...
for aa=1:height(cases)
    ...
    if (strcmp(cases.Models{aa},'DNS') || strcmp(cases.Models{aa},'DNS2'))
...
for aa=1:height(cases)
    ...
    if (strcmp(cases.Turbulence(aa),'DNS') || strcmp(cases.Turbulence(aa),'DNS2'))
...
for aa=1:height(cases)
    ...
    cases.Re_G{aa,1} = cases.rho_scaled(aa).*cases.U_x{aa,1}.*cases.d_h(aa)./cases.eta_wall{aa,1};
        ...
        % Sanity check
if ~strcmp(cases.Turbulence(aa),'DNS2')
